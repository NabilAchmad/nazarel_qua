...
export default async function Home() {
  ...
  return (
    <PublicLayout>
      ...
      {/* 1. HERO SECTION: DARK BLUE THEME (Updated) */}
      {/* Perubahan ada di class bg-gradient-to-br */}
      <section id="home" className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 pt-24 pb-36 overflow-hidden">
        ...
        {/* Abstract Background Shapes (Diperhalus agar menyatu dengan background gelap) */}
            ...
            <div className="w-full lg:w-1/2 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
              ...
              <div className="pt-8 border-t border-slate-700/50 flex items-center gap-8">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Pelanggan Puas</p>
                </div>
              </div>
            </div>
