...
export default async function Home() {
  ...
  // (Kode statistik dihapus sesuai permintaan agar lebih bersih)
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
              ...
              {/* BAGIAN STATISTIK ANGKA DIHAPUS (Sesuai Permintaan) */}
              {/* Sebagai gantinya, kita beri sedikit jarak atau fitur highlight text */}
              <div className="pt-4">
                <p className="text-sm text-slate-400 italic">
                  *Melayani antar jemput untuk wilayah Maur Baru & sekitarnya.
                </p>
              </div>
            </div>
